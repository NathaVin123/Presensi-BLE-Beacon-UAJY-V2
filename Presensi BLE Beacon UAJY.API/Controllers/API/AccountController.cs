namespace Presensi_BLE_Beacon_UAJY.API.Controllers.API
{
    using System;
    ...
    public class AccountController : ControllerBase
    {
        ...
        #region MethodosOrActions
         ...
         public async Task<IActionResult> PostUser([FromBody] NewUserRequest  request)
         {
            ...
            var user = await this.userHelper.GetUserByEmailAsync(request.NPM);
            if (user != null)
            {
                return this.BadRequest(new Response
                {
            ...
            this.emailHelper.sendMail(request.NPM, "Email confirmation", $"<h1>Email Confirmation</h1>" +
            $"To allow the user, " +
        ...
        public async Task<IActionResult> RecoverPassword([FromBody] RecoverPasswordRequest request)
        {
            ...
            this.emailHelper.sendMail(request.NPM, "Password Reset", $"<h1>Recover Password</h1>" +
