namespace ShopWeb.Controllers.API
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> PostProduct([FromBody] Presensi_BLE_Beacon_UAJY.Common.Models.Product product)
        {
            ...
            var user = await this.userHelper.GetUserByEmailAsync(product.User.NPM);
            if (user == null)
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutProduct([FromRoute] int id, [FromBody] Presensi_BLE_Beacon_UAJY.Common.Models.Product product)
        {
            if (!ModelState.IsValid)
            {
                return this.BadRequest(ModelState);
